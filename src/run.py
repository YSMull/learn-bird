...
def request_llm(model, prompt, max_tokens, temperature):
    try:
        result = llm(
            model=model,
            prompt=prompt,
...
def collect_response_from_gpt(
    db_path_list, question_list, model, knowledge_list=None
):
    """
    :param db_path: str
    :param question_list: []
...
if __name__ == "__main__":
    ...
    output_name = data_output_path + "predict_dev.json"
    # pdb.set_trace()
